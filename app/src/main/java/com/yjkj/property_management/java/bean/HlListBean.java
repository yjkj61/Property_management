...
public class HlListBean {
    ...
    @SerializedName("changeTableStatus")
    private Object changeTableStatus;
    @SerializedName("workerMoney")
    private Object workerMoney;
    ...
    public String getBookFinishDate() {
        return bookFinishDate;
    }

    public void setBookFinishDate(String bookFinishDate) {
    ...
    public Object getChangeTableStatus() {
        return changeTableStatus;
    }

    public void setChangeTableStatus(Object changeTableStatus) {
        this.changeTableStatus = changeTableStatus;
    }

    public Object getWorkerMoney() {
        return workerMoney;
    }

    public void setWorkerMoney(Object workerMoney) {
