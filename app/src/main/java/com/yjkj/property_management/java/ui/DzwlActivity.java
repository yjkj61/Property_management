...
import com.yjkj.property_management.java.adapter.DzwlAdapter;
 ...
 * @date: 2024/5/25
 */
public class DzwlActivity extends BaseActivity<ActivityDetailListBinding> {

    DzwlAdapter adapter = null;
    ...
    private void getList(){
        OkHttpUtil.getInstance().doGet(API.DZWL + "pageNum=" + pageNum + "&pageSize=" + pageSize, new Callback() {
            @Override
