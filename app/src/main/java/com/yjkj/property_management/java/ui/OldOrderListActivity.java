...
import com.yjkj.property_management.java.adapter.OldOrderAdapter;
 ...
 * @date: 2024/5/25
 */
public class OldOrderListActivity extends BaseActivity<ActivityDetailListBinding> {

    OldOrderAdapter adapter = null;
    ...
    private void getList(){
        OkHttpUtil.getInstance().doGet(API.OldOrderList + "pageNum=" + pageNum + "&pageSize=" + pageSize, new Callback() {
            @Override
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                OldOrderBean bean = new Gson().fromJson(response.body().string(), OldOrderBean.class);
                if (bean.getCode() == 200){
