...
import com.yjkj.property_management.java.adapter.HlfwAdapter;
 ...
 * @date: 2024/5/25
 */
public class HlfwActivity extends BaseActivity<ActivityDetailListBinding> {

    HlfwAdapter adapter = null;
    ...
    private void getList(){
        OkHttpUtil.getInstance().doGet(API.HL + "pageNum=" + pageNum + "&pageSize=" + pageSize, new Callback() {
            @Override
