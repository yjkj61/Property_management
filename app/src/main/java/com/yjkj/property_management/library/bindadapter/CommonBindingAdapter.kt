package com.yjkj.property_management.library.bindadapter
...
import com.yjkj.property_management.library.dsl.MotionLayoutTransitionBuilder
import com.yjkj.property_management.library.utils.ext.loadAvatar
...
object CommonBindingAdapter {
    ...
    fun bindDrawableColor(view: ImageView,color: Int?){
        color?.let {
    ...
    fun bindButtonBackgroundColor(button: View,background : Int?){
        background ?: return
    ...
    fun addCheckedChangeListener(checkBox: CheckBox, listener: CompoundButton.OnCheckedChangeListener){
    ...
    @JvmStatic
    @BindingAdapter(value = ["bind_cpb_progress"])
    fun bindCpbProgress(progress : CircularProgressBar, value : Float){
